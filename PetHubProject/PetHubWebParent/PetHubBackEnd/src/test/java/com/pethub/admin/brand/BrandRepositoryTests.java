...
@DataJpaTest
@AutoConfigureTestDatabase(replace = Replace.NONE) // test against the real db
@Rollback(false) // keep data in db
public class BrandRepositoryTests {
	...
	public void testCreateBrand3() {
		...
		samsung.getCategories().add(new Category(29)); // memo
		samsung.getCategories().add(new Category(24)); // inter hard
