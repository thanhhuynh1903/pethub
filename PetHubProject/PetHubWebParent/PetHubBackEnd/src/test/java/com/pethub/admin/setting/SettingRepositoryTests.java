...
public class SettingRepositoryTests {
	...
	public void testCreateGeneralSettings() {
		// Setting siteName = new Setting("SITE_NAME", "PetHub",
		// SettingCategory.GENERAL);
		Setting siteLogo = new Setting("SITE_LOGO", "logo_pethub.png", SettingCategory.GENERAL);
		Setting copyright = new Setting("COPYRIGHT", "Copyright (C) 2023 PetHub Ltd.", SettingCategory.GENERAL);
